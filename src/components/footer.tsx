        ...
        <footer className="bg-gray-100 py-8 mt-10 dark:bg-gray-800">
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-md font-semibold">Code Connect</span>
                        </div>
                        <p className="text-gray-500 dark:text-gray-400 text-sm">
                            High-Quality Blogs and Tutorials for Developers.
                        </p>
                        <div className="flex space-x-4">
                            <a href="https://x.com/manishsahanidev" target="_blank" rel="noopener noreferrer">
                                <Icons.twitter className="h-6 w-6 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300" />
                            </a>
                            <a
                                href="https://github.com/manishsahanidev/blog-web"
                                target="_blank"
                ...
                <div className="mt-8 border-t border-gray-200 pt-4 text-center text-xs text-gray-500 dark:border-gray-700 dark:text-gray-400">
                    &copy; 2024 Code Connect. All rights reserved.
                </div>
            </div>
        </footer>
    );
